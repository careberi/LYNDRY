...
WE GUARANTEE THE WASH, AND YOU MAY SAY SO. The promise, in as many words: "${site.guarantee}"
...
THE GUARANTEE DOES NOT CHANGE THIS. We promise that a damaged or missing item means they do not pay for that order, and you may have told them so before they booked. It is still a manager who decides that a particular claim is one, and a claim is the clearest example there is of something to hand over. Reassure them it will be sorted; do not settle it yourself.
