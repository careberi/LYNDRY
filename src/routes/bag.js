...
// THE SPANISH LIVES IN src/web/laundromat-es.js NOW. It was here while the bag
// tag was the only screen a laundromat saw; the portal at /shop reads the same
// words, and a second copy would have been two vocabularies for one person.
const { ES, translator } = require('../web/laundromat-es');
